export const protocolSteps = [
  ...
  { id:4, time:'≤ 25 min', title:'Tomografía cerebral — protocolo ACV',
    items:['TC de cerebro SIN contraste: es la primera imagen — excluye hemorragia y habilita trombólisis','Indicar en la orden: PROTOCOLO ACV URGENTE','Si NIHSS ≥ 6: solicitar angio-TC de vasos cervicocefálicos para evaluar oclusión de gran vaso','La angio-TC puede pedirse en el mismo momento que la TC sin contraste, pero no debe retrasar ni reemplazarla'],
    alert:{ type:'red', text:'La TC sin contraste es prioritaria — debe realizarse aunque la angio-TC no esté disponible' }},
