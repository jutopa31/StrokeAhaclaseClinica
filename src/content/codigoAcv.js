export const protocolSteps = [
  ...
  { id:4, time:'≤ 25 min', title:'Tomografía cerebral — protocolo ACV',
    items:['TC de cerebro SIN contraste: excluye hemorragia, habilita trombólisis','Angio-TC de vasos cervicocefálicos: pedirla JUNTO con el TC sin contraste','Indicar en la orden: PROTOCOLO ACV URGENTE','Si NIHSS ≥ 6: angio-TC es mandatoria para evaluar oclusión de gran vaso','NO pedir TC con contraste — interfiere con lectura de hemorragia'],
    alert:{ type:'red', text:'Olvidar la angio-TC junto al primer TC es el error más frecuente' }},
